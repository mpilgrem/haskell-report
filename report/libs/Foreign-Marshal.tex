...
module Foreign.Marshal (
    ...
    module Foreign.Marshal.Error, module Foreign.Marshal.Utils, unsafeLocalState
  ) where\end{verbatim}}
\haddockendheader
...
results in undefined behaviour.\par
It is expected that this operation will be
replaced in a future revision of Haskell.\par}
\end{haddockdesc}