...
module Foreign.Marshal.Array (
    ...
    newArray0, withArray, withArray0, withArrayLen, withArrayLen0, copyArray,
    moveArray, lengthArray0, advancePtr
  ) where\end{verbatim}}
\haddockendheader

The module \haddocktt{Foreign.Marshal.Array} provides operations for marshalling
 ...
 using the functions provided by \haddocktt{Foreign.C.String} as the Unicode encoding
 ...
 \haddocktt{0}—e.g., \haddockid{mallocArray} allocates space for an array of the given size,
 whereas \haddockid{mallocArray0} allocates space for one more element to ensure that
 there is room for the terminator.\par
...
Allocate storage for the given number of elements of a storable type
 (like \haddockid{malloc}, but for multiple elements).\par}
\end{haddockdesc}
\begin{haddockdesc}
\item[\begin{tabular}{@{}l}
...
Temporarily allocate space for the given number of elements
 (like \haddockid{alloca}, but for multiple elements).\par}
\end{haddockdesc}
\begin{haddockdesc}
\item[\begin{tabular}{@{}l}
...
\end{tabular}]
{\haddockbegindoc
Adjust the size of an array\par}
\end{haddockdesc}
\begin{haddockdesc}
\item[\begin{tabular}{@{}l}
...
\end{tabular}]
{\haddockbegindoc
Adjust the size of an array including an extra position for the end marker.\par}
\end{haddockdesc}
...
Convert an array of given length into a Haskell list.  The implementation
 is tail-recursive and so uses constant stack space.\par}
\end{haddockdesc}
\begin{haddockdesc}
\item[\begin{tabular}{@{}l}
...
\end{tabular}]
{\haddockbegindoc
Convert an array terminated by the given end marker into a Haskell list\par}
\end{haddockdesc}
\begin{haddockdesc}
\item[\begin{tabular}{@{}l}
...
\end{tabular}]
{\haddockbegindoc
Write the list elements consecutive into memory\par}
\end{haddockdesc}
\begin{haddockdesc}
\item[\begin{tabular}{@{}l}
...
Write a list of storable elements into a newly allocated, consecutive
 ...
 (like \haddockid{new}, but for multiple elements).\par}
\end{haddockdesc}
\begin{haddockdesc}
\item[\begin{tabular}{@{}l}
...
{\haddockbegindoc
Write a list of storable elements into a newly allocated, consecutive
 sequence of storable values, where the end is fixed by the given end marker\par}
\end{haddockdesc}
\begin{haddockdesc}
\item[\begin{tabular}{@{}l}
...
Temporarily store a list of storable values in memory
 (like \haddockid{with}, but for multiple elements).\par}
\end{haddockdesc}
\begin{haddockdesc}
\item[\begin{tabular}{@{}l}
...
\end{tabular}]
{\haddockbegindoc
Like \haddockid{withArray}, but a terminator indicates where the array ends\par}
\end{haddockdesc}
\begin{haddockdesc}
\item[\begin{tabular}{@{}l}
...
Like \haddockid{withArray}, but the action gets the number of values
 as an additional parameter\par}
\end{haddockdesc}
\begin{haddockdesc}
\item[\begin{tabular}{@{}l}
...
\end{tabular}]
{\haddockbegindoc
Like \haddockid{withArrayLen}, but a terminator indicates where the array ends\par}
\end{haddockdesc}
\subsection{Copying}
...
Copy the given number of elements from the second array (source) into the
 first array (destination); the copied areas may \emph{not} overlap\par}
\end{haddockdesc}
\begin{haddockdesc}
\item[\begin{tabular}{@{}l}
...
{\haddockbegindoc
Copy the given number of elements from the second array (source) into the
 first array (destination); the copied areas \emph{may} overlap\par}
\end{haddockdesc}
...
\end{tabular}]
{\haddockbegindoc
Return the number of elements in an array, excluding the terminator\par}
\end{haddockdesc}
\subsection{Indexing}
\begin{haddockdesc}
\item[\begin{tabular}{@{}l}
...
\end{tabular}]
{\haddockbegindoc
Advance a pointer into an array by the given number of elements\par}
\end{haddockdesc}