...
\begin{haddockdesc}
\item[\begin{tabular}{@{}l}
instance IsChar Char\\instance PrintfArg Char\\instance Storable Char\\instance Ix Char\\instance Read Char\\instance Show Char\\instance Eq Char\\instance Ord Char\\instance IArray UArray Char\\instance MArray IOUArray Char IO\\instance Foldable (UChar :: Type -> Type)\\instance Traversable (UChar :: Type -> Type)\\instance MArray STUArray s Char ST s
\end{tabular}]
\end{haddockdesc}
\begin{haddockdesc}
\item[\begin{tabular}{@{}l}
...
See \haddockid{isUpperCase} for a more intuitive predicate. Note that
 ...
 \haddocktt{'ǅ'} (\haddocktt{U+01C5} Latin capital letter d with small letter z with caron) or
