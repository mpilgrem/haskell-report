...
\begin{haddockdesc}
\item[\begin{tabular}{@{}l}
instance MonadZip Complex\\instance Foldable1 Complex
\end{tabular}]
\end{haddockdesc}
\begin{haddockdesc}
\item[\begin{tabular}{@{}l}
instance Eq1 Complex
\end{tabular}]
{\haddockbegindoc
\begin{quote}
{\haddockverb\begin{verbatim}
...
\begin{haddockdesc}
\item[\begin{tabular}{@{}l}
instance Applicative Complex\\instance Functor Complex\\instance Monad Complex\\instance MonadFix Complex\\instance Foldable Complex\\instance Traversable Complex\\instance Generic1 Complex\\instance Data a => Data Complex a\\instance RealFloat a => Floating Complex a\\instance Storable a => Storable Complex a\\instance Generic Complex a\\instance RealFloat a => Num Complex a\\instance Read a => Read Complex a\\instance RealFloat a => Fractional Complex a\\instance Show a => Show Complex a\\instance Eq a => Eq Complex a\\type instance Rep1 Complex = D1 ('MetaData "Complex" "Data.Complex" "base" 'False) (C1 ('MetaCons ":+" ('InfixI 'NotAssociative 6) 'False) (S1 ('MetaSel (('Nothing :: Maybe Symbol)) 'NoSourceUnpackedness 'SourceStrict 'DecidedStrict) Par1 :*: S1 ('MetaSel (('Nothing :: Maybe Symbol)) 'NoSourceUnpackedness 'SourceStrict 'DecidedStrict) Par1))\\type instance Rep Complex a = D1 ('MetaData "Complex" "Data.Complex" "base" 'False) (C1 ('MetaCons ":+" ('InfixI 'NotAssociative 6) 'False) (S1 ('MetaSel (('Nothing :: Maybe Symbol)) 'NoSourceUnpackedness 'SourceStrict 'DecidedStrict) (Rec0 a) :*: S1 ('MetaSel (('Nothing :: Maybe Symbol)) 'NoSourceUnpackedness 'SourceStrict 'DecidedStrict) (Rec0 a)))
\end{tabular}]
\end{haddockdesc}
\begin{haddockdesc}
\item[\begin{tabular}{@{}l}
